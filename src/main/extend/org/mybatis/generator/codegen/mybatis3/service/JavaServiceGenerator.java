...
public class JavaServiceGenerator extends AbstractJavaServiceGenerator
{
    ...
    public List<CompilationUnit> getCompilationUnits()
    {
        ...
        FullyQualifiedJavaType type = new FullyQualifiedJavaType(introspectedTable.getMyBatis3ServiceType());
        ...
        {
            rootInterface = context.getDbxServiceGeneratorConfiguration().getProperty(
