 ...
 * 
 */
public class DbxImpDeleteByPrimaryKeyMethodGenerator extends AbstractJavaServiceGenerator {

	public final static String THIS_METHOD_NAME = "dbxDeleteByPrimaryKey";

	public DbxImpDeleteByPrimaryKeyMethodGenerator() {
		super(true);
	}
	...
	public void addMethod(TopLevelClass topLevelClass) {
		...
		method.addBodyLine("");
		method.addBodyLine(" int rows= appCustomerService.deleteByPrimaryKey(t);");
