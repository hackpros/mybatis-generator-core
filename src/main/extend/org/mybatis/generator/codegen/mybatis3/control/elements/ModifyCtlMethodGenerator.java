 ...
 */
public class ModifyCtlMethodGenerator extends AbstractJavaControlGenerator
{
    public final static String THIS_METHOD_NAME = "modify";
    ...
    public ModifyCtlMethodGenerator()
    {
        super(true);
    }
    ...
    public void addMethod(TopLevelClass topLevelClass)
    {
        ...
        // 方法内容
        method.addBodyLine(MessageFormat.format("model.addAttribute(\"{1}\", {0}.selectUnique({1}));",
                fildService.getName(), bean.getName()));
        method.addBodyLine(MessageFormat.format("return \"/{0}/modify\";", bean.getName()));
