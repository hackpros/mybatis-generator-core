 ...
 * 
 */
public class DbxImpModifyMethodGenerator extends AbstractJavaServiceGenerator {

	public final static String THIS_METHOD_NAME = "dbxModify";

	public DbxImpModifyMethodGenerator() {
		super(true);
	}
	...
	public void addMethod(TopLevelClass topLevelClass) {
		...
		method.addBodyLine("//################### check param & modify business");
		method.addBodyLine("");
		method.addBodyLine("//################### end  ");
		method.addBodyLine("appCustomerService.updateByPrimaryKeySelective(t);");
