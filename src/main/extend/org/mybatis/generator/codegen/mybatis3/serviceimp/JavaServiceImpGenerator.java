 ...
 */
package org.mybatis.generator.codegen.mybatis3.serviceimp;
...
import org.mybatis.generator.codegen.mybatis3.serviceimp.elements.AppendImpMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.serviceimp.elements.BrowserImpMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.serviceimp.elements.ConstructorMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.serviceimp.elements.DeleteImpMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.serviceimp.elements.SelectUniqueImpMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.serviceimp.elements.UpdateImpMethodGenerator;
 ...
 * 
 */
public class JavaServiceImpGenerator extends AbstractJavaServiceGenerator
{

    /**
     * 
     */
    public JavaServiceImpGenerator()
    {
        super(true);
    }

    public JavaServiceImpGenerator(boolean requiresMatchedXMLGenerator)
    {
    ...
    {
        FullyQualifiedJavaType type = new FullyQualifiedJavaType(introspectedTable.getMyBatis3ServiceImpType());
        ...
        // 实现接口
        FullyQualifiedJavaType serviceInterfaceType =new FullyQualifiedJavaType(introspectedTable.getMyBatis3ServiceType());
        ...
        {
            rootInterface = context.getDbxServiceImpGeneratorConfiguration().getProperty(
    ...
    private void addBrowserImpMethod(TopLevelClass topLevelClass)
    {
        AbstractJavaServiceGenerator methodGenerator = new BrowserImpMethodGenerator();
        initializeAndExecuteGenerator(methodGenerator, topLevelClass);
    }

    private void addAppendImpMethod(TopLevelClass topLevelClass)
    {
        AbstractJavaServiceGenerator methodGenerator = new AppendImpMethodGenerator();
        initializeAndExecuteGenerator(methodGenerator, topLevelClass);
    }
    ...
    private void addUpdateImpMethod(TopLevelClass topLevelClass)
    {
        AbstractJavaServiceGenerator methodGenerator = new UpdateImpMethodGenerator();
        initializeAndExecuteGenerator(methodGenerator, topLevelClass);
    }

    private void addSelectUniqueImpMethod(TopLevelClass topLevelClass)
    {
        AbstractJavaServiceGenerator methodGenerator = new SelectUniqueImpMethodGenerator();
        initializeAndExecuteGenerator(methodGenerator, topLevelClass);
    }
