 ...
 * 
 */
public class DbxImpDeleteByExampleMethodGenerator extends AbstractJavaServiceGenerator {

	public final static String THIS_METHOD_NAME = "dbxDeleteByExample";

	public DbxImpDeleteByExampleMethodGenerator() {
		super(true);
	}
	...
	public void addMethod(TopLevelClass topLevelClass) {
		...
		method.addBodyLine("SoaResult<Integer> res=new SoaResult<Integer>();");
		method.addBodyLine("try {");
		method.addBodyLine(MessageFormat.format("{0} e = new {1}();" ,examp.getShortName(),examp.getShortName()));
		method.addBodyLine("//################### add your delete business");
		method.addBodyLine("");
		method.addBodyLine("");
		method.addBodyLine("//################### end");
		method.addBodyLine("int rows=appCustomerService.deleteByExample(e);");
		method.addBodyLine("res.setCode(0);");
		method.addBodyLine("//################### return delete rows ");
