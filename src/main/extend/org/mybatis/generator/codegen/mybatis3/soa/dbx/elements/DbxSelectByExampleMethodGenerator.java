 ...
 * 
 */
public class DbxSelectByExampleMethodGenerator extends
        AbstractJavaMapperMethodGenerator {

    public final static String THIS_METHOD_NAME="dbxSelectByExample";
    
    public DbxSelectByExampleMethodGenerator() {
        super();
    }
    ...
    public void addInterfaceElements(Interface interfaze) {
		...
		FullyQualifiedJavaType returnType = new FullyQualifiedJavaType("SoaResult<Pages<" + resParameterType.getFullyQualifiedName() + ">>");
		method.setReturnType(returnType);
		method.setName(THIS_METHOD_NAME);
        
        FullyQualifiedJavaType pageParam=new FullyQualifiedJavaType("Pages<" + resParameterType.getFullyQualifiedName() + ">");
