 ...
 */
public class DoModifyCtlMethodGenerator extends AbstractJavaControlGenerator
{

    public final static String THIS_METHOD_NAME = "doModify";
    ...
    public DoModifyCtlMethodGenerator()
    {
        super(true);
    ...
    public void addMethod(TopLevelClass topLevelClass)
    {
        ...
        // 方法内容
        method.addBodyLine(MessageFormat.format("model.addAttribute(\"{1}\", {0}.update({1}));",
    ...
    public void addAnnotations(TopLevelClass topLevelClass, Method method)
    {
        ...
        //method.addJavaDocLine(" */"); //$NON-NLS-1$
        method.addAnnotation("@RequestMapping(value = \"/doModify\", method = RequestMethod.POST)");
    }
