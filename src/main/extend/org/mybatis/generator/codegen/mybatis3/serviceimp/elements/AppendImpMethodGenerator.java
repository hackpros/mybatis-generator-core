 ...
 * 
 */
public class AppendImpMethodGenerator extends AbstractJavaServiceGenerator {

	public final static String THIS_METHOD_NAME = "append";

	public AppendImpMethodGenerator() {
		super(true);
	}
	...
	public void addMethod(TopLevelClass topLevelClass) {
		...
		method.addBodyLine("/** 新增业务逻辑 **/");
		method.addBodyLine("");
		method.addBodyLine("");
		method.addBodyLine("/** 新增业务逻辑完 **/");
		method.addBodyLine("/**######################_我是分隔线######################**/");
		method.addBodyLine("");
		method.addBodyLine(MessageFormat.format("return {0}.insert({1});", mapperFild, parameter.getName()));
