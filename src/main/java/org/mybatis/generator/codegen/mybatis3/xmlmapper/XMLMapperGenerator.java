...
public class XMLMapperGenerator extends AbstractXmlGenerator {
	...
	protected XmlElement getSqlMapElement() {
        ...
        */
		// TODO
		// ############################################
		// ####### 2016-07-01　author renntrabbit@foxmail.com
		/**
		 * 是否生成xml内容，此处生成一个空的xml，用的用户自定义sql
		 */
		if (context.getSqlMapGeneratorConfiguration().isTargetBody()) {
			...
			context.getCommentGenerator().addDexXmlComment(answer);
		}
