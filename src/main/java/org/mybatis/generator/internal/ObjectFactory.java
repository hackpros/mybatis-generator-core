...
import org.mybatis.generator.api.dom.DefaultUIFormatter;
...
public class ObjectFactory {
    ...
    public static UIFormatter createUIFormatter(Context context) {
        String type = context.getProperty(PropertyRegistry.CONTEXT_UI_FORMATTER);
        if (!StringUtility.stringHasValue(type)) {
            type = DefaultUIFormatter.class.getName();
        }

        UIFormatter answer = (UIFormatter) createInternalObject(type);
