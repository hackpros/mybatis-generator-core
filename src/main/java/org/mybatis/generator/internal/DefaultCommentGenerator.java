...
public class DefaultCommentGenerator implements CommentGenerator
{
    ...
    public void addJavaFileComment(CompilationUnit compilationUnit, IntrospectedTable introspectedTable)
    {
        ...
        compilationUnit.addFileCommentLine(" * " + introspectedTable.getFullyQualifiedTable().getComment());
        compilationUnit.addFileCommentLine(" * " + compilationUnit.getType().getShortName() + ".java");
        compilationUnit.addFileCommentLine(" * Copyright(C) 2015-2015 xxxxxx公司");
