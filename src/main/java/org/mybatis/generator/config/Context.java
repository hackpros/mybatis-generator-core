...
import org.mybatis.generator.api.UIFormatter;
...
public class Context extends PropertyHolder {
	...
	// 生成service　实现类
	private JavaServiceImpGeneratorConfiguration javaServiceImpGeneratorConfiguration;

	// 生成ui页面　实现类
	private UIGeneratorConfiguration uiGeneratorConfiguration;

	// 生成js脚本　实现类
	private JavaScriptGeneratorConfiguration javaScriptGeneratorConfiguration;

	// 生成js 脚本　实现类
	private JavaControlGeneratorConfiguration javaControlGeneratorConfiguration;

	
	
	// 生成 第四层daoservice接口类
	private DaoServiceGeneratorConfiguration daoServiceGeneratorConfiguration;

	// 生成第四层daoservice接口类
	private DaoServiceImpGeneratorConfiguration daoServiceImpGeneratorConfiguration;

	// 生成dubboxaip
	private DbxServiceGeneratorConfiguration dbxServiceGeneratorConfiguration;

	// 生成service　实现类
	private DbxServiceImpGeneratorConfiguration dbxServiceImpGeneratorConfiguration;
	
	// 生成单元测试配置对象
	private JavaJunitGeneratorConfiguration javaJunitGeneratorConfiguration;
		
	// 生成业务模型对象
	private JavaBusinessModelGeneratorConfiguration javaBusinessModelGeneratorConfiguration;
	 ...
	 * 生成多个xml　java类
	 */
	private List<SqlMapGeneratorConfiguration> sqlMapGeneratorConfigurations = new ArrayList<SqlMapGeneratorConfiguration>();

	private List<JavaClientGeneratorConfiguration> javaClientGeneratorConfigurations = new ArrayList<JavaClientGeneratorConfiguration>();

	public List<SqlMapGeneratorConfiguration> getSqlMapGeneratorConfigurations() {
		return sqlMapGeneratorConfigurations;
	}

	public void setSqlMapGeneratorConfigurations(List<SqlMapGeneratorConfiguration> sqlMapGeneratorConfigurations) {
		this.sqlMapGeneratorConfigurations = sqlMapGeneratorConfigurations;
	}

	public List<JavaClientGeneratorConfiguration> getJavaClientGeneratorConfigurations() {
		return javaClientGeneratorConfigurations;
	}

	public void setJavaClientGeneratorConfigurations(List<JavaClientGeneratorConfiguration> javaClientGeneratorConfigurations) {
		this.javaClientGeneratorConfigurations = javaClientGeneratorConfigurations;
	}
	...
	public JavaServiceImpGeneratorConfiguration getJavaServiceImpGeneratorConfiguration() {
		return javaServiceImpGeneratorConfiguration;
	}

	public void setJavaServiceImpGeneratorConfiguration(JavaServiceImpGeneratorConfiguration javaServiceImpGeneratorConfiguration) {
		this.javaServiceImpGeneratorConfiguration = javaServiceImpGeneratorConfiguration;
	}

	public UIGeneratorConfiguration getUiGeneratorConfiguration() {
		return uiGeneratorConfiguration;
	}

	public void setUiGeneratorConfiguration(UIGeneratorConfiguration uiGeneratorConfiguration) {
		this.uiGeneratorConfiguration = uiGeneratorConfiguration;
	}

	public JavaScriptGeneratorConfiguration getJavaScriptGeneratorConfiguration() {
		return javaScriptGeneratorConfiguration;
	}

	public void setJavaScriptGeneratorConfiguration(JavaScriptGeneratorConfiguration javaScriptGeneratorConfiguration) {
		this.javaScriptGeneratorConfiguration = javaScriptGeneratorConfiguration;
	}

	public JavaControlGeneratorConfiguration getJavaControlGeneratorConfiguration() {
		return javaControlGeneratorConfiguration;
	}

	public void setJavaControlGeneratorConfiguration(JavaControlGeneratorConfiguration javaControlGeneratorConfiguration) {
		this.javaControlGeneratorConfiguration = javaControlGeneratorConfiguration;
	}
	...
	public DaoServiceGeneratorConfiguration getDaoServiceGeneratorConfiguration() {
		return daoServiceGeneratorConfiguration;
	}

	public void setDaoServiceGeneratorConfiguration(DaoServiceGeneratorConfiguration daoServiceGeneratorConfiguration) {
		this.daoServiceGeneratorConfiguration = daoServiceGeneratorConfiguration;
	}

	public DaoServiceImpGeneratorConfiguration getDaoServiceImpGeneratorConfiguration() {
		return daoServiceImpGeneratorConfiguration;
	}

	public void setDaoServiceImpGeneratorConfiguration(DaoServiceImpGeneratorConfiguration daoServiceImpGeneratorConfiguration) {
		this.daoServiceImpGeneratorConfiguration = daoServiceImpGeneratorConfiguration;
	}

	public DbxServiceGeneratorConfiguration getDbxServiceGeneratorConfiguration() {
		return dbxServiceGeneratorConfiguration;
	}

	public void setDbxServiceGeneratorConfiguration(DbxServiceGeneratorConfiguration dbxServiceGeneratorConfiguration) {
		this.dbxServiceGeneratorConfiguration = dbxServiceGeneratorConfiguration;
	}

	public DbxServiceImpGeneratorConfiguration getDbxServiceImpGeneratorConfiguration() {
		return dbxServiceImpGeneratorConfiguration;
	}

	public void setDbxServiceImpGeneratorConfiguration(DbxServiceImpGeneratorConfiguration dbxServiceImpGeneratorConfiguration) {
		this.dbxServiceImpGeneratorConfiguration = dbxServiceImpGeneratorConfiguration;
	}
	

	public JavaJunitGeneratorConfiguration getJavaJunitGeneratorConfiguration() {
		return javaJunitGeneratorConfiguration;
	}

	public void setJavaJunitGeneratorConfiguration(JavaJunitGeneratorConfiguration javaJunitGeneratorConfiguration) {
		this.javaJunitGeneratorConfiguration = javaJunitGeneratorConfiguration;
	}

	public JavaBusinessModelGeneratorConfiguration getJavaBusinessModelGeneratorConfiguration() {
		return javaBusinessModelGeneratorConfiguration;
	}

	public void setJavaBusinessModelGeneratorConfiguration(JavaBusinessModelGeneratorConfiguration javaBusinessModelGeneratorConfiguration) {
		this.javaBusinessModelGeneratorConfiguration = javaBusinessModelGeneratorConfiguration;
	}
	...
	public XmlElement toXmlElement() {
		...
		if (sqlMapGeneratorConfiguration != null) {
			for (SqlMapGeneratorConfiguration sqlMapGeneratorConfiguration : sqlMapGeneratorConfigurations) {
	...
	public UIFormatter getUIFormatter() {
		if (uiFormatter == null) {
			uiFormatter = ObjectFactory.createUIFormatter(this);
		}
	...
	public void generateFiles(ProgressCallback callback, List<GeneratedJavaFile> generatedJavaFiles,
			List<GeneratedXmlFile> generatedXmlFiles, List<GeneratedUIFile> generatedUIFiles, List<String> warnings)
			throws InterruptedException {
		...
		if (introspectedTables != null) {
			for (IntrospectedTable introspectedTable : introspectedTables) {
				...
				generatedUIFiles.addAll(introspectedTable.getGeneratedUIFiles(introspectedTable));

				generatedJavaFiles.addAll(pluginAggregator.contextGenerateAdditionalJavaFiles(introspectedTable));
				generatedXmlFiles.addAll(pluginAggregator.contextGenerateAdditionalXmlFiles(introspectedTable));
				generatedUIFiles.addAll(pluginAggregator.contextGenerateAdditionalUIFiles(introspectedTable));
			}
		}
