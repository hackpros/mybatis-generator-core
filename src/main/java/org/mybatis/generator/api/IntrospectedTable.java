...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_DAOSERVICE_INTERFACE_TYPE,
        ATTR_DAOSERVICE_IMPLEMENTATION_TYPE,
        
        ATTR_DBXSERVICE_INTERFACE_TYPE,
        ATTR_DBXSERVICE_IMPLEMENTATION_TYPE,
        
        
        ATTR_BUSINESS_MODEL_TYPE,
        ATTR_JUNIT_TEST_TYPE,
    ...
    //#######################################################
    /**
     * 业务请求模型,不使用继承是考虑到 使用dbx服务
     * 默认等于数据模型 
     */
    protected FullyQualifiedJavaType reqFullyQualifiedJavaType;
    /**
     * 业务返回模型,不使用继承是考虑到 使用dbx服务
     * 默认等于数据模型 
     */
    protected FullyQualifiedJavaType resFullyQualifiedJavaType;
    ...
    protected void calculateUIAttributes() {
        //setIbatis2SqlMapPackage(calculateSqlMapPackage());
        //setIbatis2SqlMapFileName(calculateIbatis2SqlMapFileName());
        //setMyBatis3XmlMapperFileName(calculateMyBatis3XmlMapperFileName());
        //setMyBatis3XmlMapperPackage(calculateSqlMapPackage());
        setMyBatis3UIFileName(calculateMyBatis3UIFileName());
        setMyBatis3UIPackage(calculateUIPackage());
    }
    ...
    protected String calculateJavaServiceImpPackage() {
        JavaServiceImpGeneratorConfiguration config = context
                .getJavaServiceImpGeneratorConfiguration();
        if (config == null) {
            return null;
        }
    ...
    protected String calculateDaoServicePackage() {
        DaoServiceGeneratorConfiguration config = context
                .getDaoServiceGeneratorConfiguration();
        if (config == null) {
            return null;
        }
    ...
    protected String calculateDaoServiceImpPackage() {
    	DaoServiceImpGeneratorConfiguration config = context
                .getDaoServiceImpGeneratorConfiguration();
        if (config == null) {
            return null;
        }
    ...
    protected String calculateDbxServicePackage() {
        DbxServiceGeneratorConfiguration config = context
                .getDbxServiceGeneratorConfiguration();
        if (config == null) {
            return null;
        }
    ...
    protected String calculateDbxServiceImpPackage() {
        DbxServiceImpGeneratorConfiguration config = context
                .getDbxServiceImpGeneratorConfiguration();
        if (config == null) {
            return null;
        }
    ...
    protected String calculateJavaBusinessModelPackag() {
    	JavaBusinessModelGeneratorConfiguration config = context
                .getJavaBusinessModelGeneratorConfiguration();
        if (config == null) {
            return null;
        }
    ...
    protected String calculateJavaJunitPackage() {
    	JavaJunitGeneratorConfiguration config = context
                .getJavaJunitGeneratorConfiguration();
        if (config == null) {
            return null;
        }
    ...
    protected String calculateJavaControlPackage() {
        JavaControlGeneratorConfiguration config = context
                .getJavaControlGeneratorConfiguration();
        if (config == null) {
            return null;
        }
    ...
    protected void calculateJavaClientAttributes() {
        ...
        setMyBatis3ServiceType(sb.toString());
        
        //###############################
        //生成serivce实现类代码
        sb.setLength(0);
        sb.append(calculateJavaServiceImpPackage());
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("ServiceImp"); //$NON-NLS-1$
        setMyBatis3ServiceImpType(sb.toString());
        
        
        //###############################2016-10-24 11:08:10
        //生成dao serivce实现类及接口
        sb.setLength(0);
        sb.append(calculateDaoServicePackage());
        sb.append('.');
        sb.append('I');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("Service"); //$NON-NLS-1$
        setMyBatis3DaoServiceType(sb.toString());
        
        sb.setLength(0);
        sb.append(calculateDaoServiceImpPackage());
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("ServiceImp"); //$NON-NLS-1$
        setMyBatis3DaoServiceImpType(sb.toString());
        
        //生成dubbox serivce实现类及接口
        
        sb.setLength(0);
        sb.append(calculateDbxServicePackage());
        sb.append('.');
        sb.append('I');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("Api"); //$NON-NLS-1$
        setMyBatis3DbxServiceType(sb.toString());
        
        sb.setLength(0);
        sb.append(calculateDbxServiceImpPackage());
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("DbxApi"); //$NON-NLS-1$
        setMyBatis3DbxServiceImpType(sb.toString());
        //###############################2016-10-24 11:08:10
        
        //###############################
        //###############################
        //junit business model 
        //create by 2016-11-21 10:45:32
        sb.setLength(0);
        sb.append(calculateJavaBusinessModelPackag());
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append(""); //$NON-NLS-1$
        setMyBatis3BusinessModelType(sb.toString());
        
        
        sb.setLength(0);
        sb.append(calculateJavaJunitPackage());
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("Test"); //$NON-NLS-1$
        setJavaBatis3JunitTestType(sb.toString());
        //###############################
        //###############################
        ...
        //生成control实现类代码
        sb.setLength(0);
        sb.append(calculateJavaControlPackage());
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("Controller"); //$NON-NLS-1$
        setMyBatis3ControlType(sb.toString());
    }
    ...
    protected String calculateUIPackage() {
        StringBuilder sb = new StringBuilder();
        UIGeneratorConfiguration config = context
                .getUiGeneratorConfiguration();
    ...
    protected String calculateMyBatis3UIFileName() {
        StringBuilder sb = new StringBuilder();
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append(".vm"); //$NON-NLS-1$
        return sb.toString();
    }
     ...
     * SqlMap file.
     * 
     * @return the list of generated ui files for this table
     */
    public abstract List<GeneratedUIFile> getGeneratedUIFiles(IntrospectedTable tntrospectedTable);
    ...
    public void setMyBatis3UIPackage(String mybatis3UIPackage) {
        internalAttributes.put(
                InternalAttribute.ATTR_UI_TYPE,
                mybatis3UIPackage);
    }
    public String getMyBatis3UIPackage() {
       return internalAttributes.get(InternalAttribute.ATTR_UI_TYPE);
    }
    ...
    public void setMyBatis3UIFileName(String mybatis3UIFileName) {
        internalAttributes.put(
                InternalAttribute.ATTR_UI_TYPE,
                mybatis3UIFileName);
    }
    public String getMyBatis3UIFileName() {
        return internalAttributes.get(InternalAttribute.ATTR_UI_TYPE);
    }
    ...
    public void setMyBatis3ServiceType(String attrServiceInterfaceType) {
        internalAttributes.put(
                InternalAttribute.ATTR_SERVICE_INTERFACE_TYPE,
                attrServiceInterfaceType);
    }
    public String getMyBatis3ServiceType() {
        return internalAttributes
                .get(InternalAttribute.ATTR_SERVICE_INTERFACE_TYPE);
    }
    
    public void setMyBatis3ServiceImpType(String attrServiceInterfaceType) {
        internalAttributes.put(
                InternalAttribute.ATTR_SERVICE_IMPLEMENTATION_TYPE,
                attrServiceInterfaceType);
    }

    public String getMyBatis3ServiceImpType() {
        return internalAttributes
                .get(InternalAttribute.ATTR_SERVICE_IMPLEMENTATION_TYPE);
    }
    
    
    //############################### 2016-10-24 11:36:39
    public String getMyBatis3DaoServiceType() {
        return internalAttributes
                .get(InternalAttribute.ATTR_DAOSERVICE_INTERFACE_TYPE);
    }
    
    public void setMyBatis3DaoServiceType(String attrServiceInterfaceType) {
        internalAttributes.put(
                InternalAttribute.ATTR_DAOSERVICE_INTERFACE_TYPE,
                attrServiceInterfaceType);
    }
    
    public String getMyBatis3DaoServiceImpType() {
        return internalAttributes
                .get(InternalAttribute.ATTR_DAOSERVICE_IMPLEMENTATION_TYPE);
    }
    
    public void setMyBatis3DaoServiceImpType(String attrServiceInterfaceType) {
        internalAttributes.put(
                InternalAttribute.ATTR_DAOSERVICE_IMPLEMENTATION_TYPE,
                attrServiceInterfaceType);
    }
    
    public String getMyBatis3DbxServiceType() {
    	return internalAttributes.get(InternalAttribute.ATTR_DBXSERVICE_INTERFACE_TYPE);
    }
    
    public void setMyBatis3DbxServiceType(String attrServiceInterfaceType) {
        internalAttributes.put(
                InternalAttribute.ATTR_DBXSERVICE_INTERFACE_TYPE,
                attrServiceInterfaceType);
    }
    
   public String getMyBatis3DbxServiceImpType() {
        return internalAttributes
                .get(InternalAttribute.ATTR_DBXSERVICE_IMPLEMENTATION_TYPE);
    }
   
    public void setMyBatis3DbxServiceImpType(String attrServiceInterfaceType) {
        internalAttributes.put(
                InternalAttribute.ATTR_DBXSERVICE_IMPLEMENTATION_TYPE,
                attrServiceInterfaceType);
    }
    
    
    public String getBatis3JavaJunitTestType() {
        return internalAttributes
                .get(InternalAttribute.ATTR_JUNIT_TEST_TYPE);
    }
    public void setJavaBatis3JunitTestType(String attrServiceInterfaceType) {
    	 internalAttributes.put(
                 InternalAttribute.ATTR_JUNIT_TEST_TYPE,
                 attrServiceInterfaceType);
    }
    public void setMyBatis3BusinessModelType(String attrServiceInterfaceType) {
        internalAttributes.put(
                InternalAttribute.ATTR_BUSINESS_MODEL_TYPE,
                attrServiceInterfaceType);
        
        
        String reqType = attrServiceInterfaceType+"Req";
        reqType=String.format(reqType, "request");
        
        String resType = attrServiceInterfaceType+"Res";
        resType=String.format(resType, "response");
        
        this.setReqFullyQualifiedJavaType(new FullyQualifiedJavaType(reqType)); 
    	this.setResFullyQualifiedJavaType(new FullyQualifiedJavaType(resType));	
        
    }
    public String getMyBatis3BusinessModelType() {
    ...
    public void setMyBatis3ControlType(String attrServiceInterfaceType) {
        internalAttributes.put(
                InternalAttribute.ATTR_CONTROL_TYPE,
                attrServiceInterfaceType);
    }

    public String getMyBatis3ControlType() {
        return internalAttributes
                .get(InternalAttribute.ATTR_CONTROL_TYPE);
    }
    ...
    public FullyQualifiedJavaType getReqFullyQualifiedJavaType() {
		return reqFullyQualifiedJavaType;
	}

	public void setReqFullyQualifiedJavaType(FullyQualifiedJavaType reqFullyQualifiedJavaType) {
		this.reqFullyQualifiedJavaType = reqFullyQualifiedJavaType;
	}

	public FullyQualifiedJavaType getResFullyQualifiedJavaType() {
		return resFullyQualifiedJavaType;
	}

	public void setResFullyQualifiedJavaType(FullyQualifiedJavaType resFullyQualifiedJavaType) {
		this.resFullyQualifiedJavaType = resFullyQualifiedJavaType;
	}
