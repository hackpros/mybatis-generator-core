...
public class MyBatisGenerator {
     ...
     * ui页面
     */
    private List<GeneratedUIFile> generatedUIFiles;
    ...
    public MyBatisGenerator(Configuration configuration, ShellCallback shellCallback,
        ...
        generatedUIFiles = new ArrayList<GeneratedUIFile>();
    ...
    public void generate(ProgressCallback callback, Set<String> contextIds,
        ...
        for (Context context : contextsToRun) {
            context.generateFiles(callback, generatedJavaFiles,
                    generatedXmlFiles,generatedUIFiles ,warnings);
        }

        // now save the files
        callback.saveStarted(generatedXmlFiles.size()
                + generatedJavaFiles.size()+generatedUIFiles.size());
        ...
        for (GeneratedUIFile gxf : generatedUIFiles) {
            projects.add(gxf.getTargetProject());
